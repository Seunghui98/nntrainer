 ...
 *     it skips the max pass but still reaches exp, the result is undefined --
 *     not a small numerical error a tolerance would catch. Running both
 *     passes over the SAME lane set is what makes x - max <= 0 true by
 *     construction.
 *
