 ...
 * shape & size; the actual matmul is dispatched from FloatTensor's GEMM path
 * (FloatTensor::dotQnK -> dequantize_row_q8_0 + sgemm). Mutating operations
 * throw - Q8_0 is a load-only weight tensor.
 */
