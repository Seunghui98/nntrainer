 ...
 */
quick_ai::json makeTinyLfm2Config() {
  return {
...
makeLfm2LayerDtypeMap(const quick_ai_test::TinyCausalLMDataType &data_type) {
...
makeLfm2Case(const quick_ai_test::TinyCausalLMDataType &data_type) {
  return {
...
INSTANTIATE_TEST_SUITE_P(
  ...
  ::testing::Values(makeLfm2Case(quick_ai_test::makeTinyFp32DataType()),
                    makeLfm2Case(quick_ai_test::makeTinyQ40Fp32DataType())),
