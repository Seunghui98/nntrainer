 ...
 * entire kv_len. See MHA_HTP_PLAN.md §4.1/§4.5.
 *
 ...
 * need naming (MHA_HTP_PLAN.md §9.4, flash-attention task §7):
 *
 ...
 *      once masking restricts them (MHA_HTP_PLAN.md §5.4).
 ...
 * accumulate over the entire kv_len first (MHA_HTP_U8_TASKS.md §1.7).
 *
