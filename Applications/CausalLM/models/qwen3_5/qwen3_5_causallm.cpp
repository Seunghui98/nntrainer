...
void Qwen3_5CausalLM::constructModel() {
  ...
  // Add lm_head on top of output_norm. Transformer::initialize() owns the
  // setProperty/compile/initialize sequence after constructModel returns,
  // so the hybrid graph follows the same flow as the other CausalLM models.
