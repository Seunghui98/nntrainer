...
BertDecoder::createCrossCachePlaceholders(int layer_id, unsigned int enc_len) {
  ...
  // caption became image-agnostic. Create real "input" LAYER nodes (FP16) so
  // getType()=="input", they are collected, and they receive the prefilled
...
// ---------------------------------------------------------------------------
// decodeToken  (autoregressive single-step used by ScreenAICaption)
// ---------------------------------------------------------------------------
