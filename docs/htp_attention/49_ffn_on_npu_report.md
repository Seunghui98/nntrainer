...
|---|---:|---:|---:|
| **행렬곱만** (한 MoE 레이어, 444 토큰, 39 GFLOP) | 26.3 ms | **12.2 ms** | **2.2×** |
...
토큰 1개는 expert 4개의 가중치 21.5 MB를 읽어 88 MFLOP를 계산한다. 계산은 0에 가깝고
**읽기가 전부**다.

| | CPU | NPU |
|---|---:|---:|
| 가중치 읽기 | 21.5 MB / 24 GB/s = 0.88 ms | DMA 21.5 MB / 15.7 GB/s = 1.37 ms |
